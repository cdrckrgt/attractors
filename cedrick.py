...
def cedrick(x, y, a=-0.709, b=1.638, c=0.452, d=1.74):
    x_prime = math.cos(a * y) - math.cos(b * x)
    y_prime = math.sin(c * x) - math.sin(d * y)
...
plt.imsave('cedrick.png', im, dpi=600, origin='lower')
